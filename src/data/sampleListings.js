...
export const sampleListings = {
  강남: [
    ...
    },
    {
      ...
      transportScore: "180m",
      description:
        "지하철역에서 도보 3분, 대학가와 가까워 학업·문화생활 동시에 즐기기 좋습니다.",
    },
    {
      title: "강남 E 투룸",
      imageUrl: room2,
      ...
      transportScore: "220m",
      description:
        "넓은 실내 공간과 깨끗한 인테리어가 특징입니다. 주변 공원 산책로도 가까워 여가 생활이 편리합니다.",
    },
    {
      title: "강남 F 오피스텔",
      imageUrl: room6,
      ...
      transportScore: "250m",
      description:
        "도심 속 판교 테크노밸리와 가까워 직장인 출퇴근이 편리합니다. 24시간 편의점 인접.",
    },
    {
      title: "강남 G 스튜디오",
      imageUrl: room7,
      ...
      transportScore: "130m",
      description:
        "작지만 효율적인 구조의 스튜디오 타입. 독립적인 작업 공간이나 취미 생활을 원하는 분에게 추천합니다.",
    },
    {
      title: "강남 H 하우스",
      imageUrl: room1,
      ...
      transportScore: "300m",
      description:
        "고급 주거 단지 내 위치해 보안이 철저합니다. 지하 주차장과 피트니스 센터가 있어 편리합니다.",
    },
    {
      title: "강남 I 펜트하우스",
      imageUrl: room9,
      ...
      transportScore: "100m",
      description:
        "최상층에 위치해 한강 뷰가 뛰어납니다. 넓은 테라스와 고급 가전이 풀옵션으로 제공됩니다.",
    },
  ],
  홍대: [
    {
